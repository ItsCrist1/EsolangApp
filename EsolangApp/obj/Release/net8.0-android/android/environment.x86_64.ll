...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2702714135890655323, ; hash 0x2581f82fdf30785b, from name: libaot-EsolangApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 69
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2851392019598056470, ; hash 0x27922def3b869c16, from name: libaot-EsolangApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 72
	...
	%struct.DSOCacheEntry {
		i64 9458411392265094910, ; hash 0x8343070c677806fe, from name: EsolangApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 245
	...
	%struct.DSOCacheEntry {
		i64 10883229713177867704, ; hash 0x9708ffc326f175b8, from name: aot-EsolangApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 280
	...
	%struct.DSOCacheEntry {
		i64 12019423111098329070, ; hash 0xa6cd91a34e22e7ee, from name: EsolangApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 316
	...
	%struct.DSOCacheEntry {
		i64 14745511153162958994, ; hash 0xcca29444cbd6b892, from name: aot-EsolangApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 396
...
@.env.3 = private unnamed_addr constant [37 x i8] c"96d7fbdc-4182-46c0-96d7-0f48df50a732\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.esolangapp\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-EsolangApp.dll.so\00", align 16
