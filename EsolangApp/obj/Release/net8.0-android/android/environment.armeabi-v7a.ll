...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 106309038, ; hash 0x65625ae, from name: libaot-EsolangApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2995279739, ; hash 0xb288577b, from name: aot-EsolangApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 350
	...
	%struct.DSOCacheEntry {
		i64 3165719709, ; hash 0xbcb10c9d, from name: libaot-EsolangApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 374
	...
	%struct.DSOCacheEntry {
		i64 3484284183, ; hash 0xcfadf517, from name: aot-EsolangApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 403
	...
	%struct.DSOCacheEntry {
		i64 3749917380, ; hash 0xdf8332c4, from name: EsolangApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 431
	...
	%struct.DSOCacheEntry {
		i64 4205141415, ; hash 0xfaa55da7, from name: EsolangApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EsolangApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 484
